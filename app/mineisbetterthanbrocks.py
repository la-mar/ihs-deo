...
# <EXPORT>  <TEXTUAL_EXPORTS> <WELL_XML EXCLUDE_MISSING_LATLONGS='TRUE' INCLUDE_PRODFIT='TRUE' INCLUDE_SUBSCRIBED_LATLONG_SOURCES='TRUE'>    <BRANCH NAME='/WELL_SET/WELLBORE/HEADER'/>    <BRANCH NAME='/WELL_SET/WELLBORE/LOCATION'/>   </WELL_XML>  </TEXTUAL_EXPORTS> </EXPORT
