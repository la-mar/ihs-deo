...
Bindings:
     Soap11Binding: {
          http: //www.ihsenergy.com/Enerdeq/Schemas/QueryBuilder}QueryBuilderServiceSoap

               Service: QueryBuilderService
          Port: QueryBuilderServiceSoap(Soap11Binding: {
                         http: //www.ihsenergy.com/Enerdeq/Schemas/QueryBuilder}QueryBuilderServiceSoap)
                              Operations: DeleteQuery(QueryName: xsd: string, _soapheaders = {
                                   request_header: ns0: Header
                              }) - > Result: xsd: string
                         GetAttributes(Query: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         GetChangesAndDeletes(DataType: xsd: string, FromDate: xsd: string, ToDate: xsd: string, Page: xsd: int, Domain: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > PagingDetails: ns1: PagingResponse,
                         Result: xsd: string
                         GetChangesAndDeletesFromIds(DataType: xsd: string, Ids: ns1: ArrayOfId, FromDate: xsd: string, ToDate: xsd: string, Domain: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > PagingDetails: ns1: PagingResponse,
                         Result: xsd: string
                         GetCount(Query: xsd: string, TagrgetDatatype: xsd: string, Domain: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         GetCurrentIds(Domain: xsd: string, DataType: xsd: string, Page: xsd: int, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Ids: ns1: ArrayOfId,
                         PagingDetails: ns1: PagingResponse
                         GetDailyUpdateInterval(UpdateDate: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) -
                         > UpdateStarted: xsd: dateTime,
                         UpdateEnded: xsd: dateTime
                         GetEntityType(Parameters: ns2: GetEntityTypeParameters, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         GetKeys(Query: xsd: string, TagrgetDatatype: xsd: string, Domain: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: ns1: ArrayOfStrings
                         GetLookups(DataType: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: ns2: ArrayOfLookupTypes
                         GetProductionEntityAttributes(Parameters: ns2: GetProductionEntityAttributesParameters, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         GetQueryDefinition(QueryName: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         GetSQL(Query: xsd: string, Type: ns2: SQLType, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         GetSavedQueries(Domain: xsd: string, Datatype: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Queries: ns1: ArrayOfStrings
                         LookupAttributes(Parameters: ns2: LookupAttrsParameters, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         LookupCode(Parameters: ns2: LookupParameters, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Codes: ns1: ArrayOfStrings
                         LookupName(Parameters: ns2: LookupParameters, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Names: ns1: ArrayOfStrings
                         LookupNameCode(Parameters: ns2: LookupParameters, SearchType: ns2: NameCodeType, _soapheaders = {
                              request_header: ns0: Header
                         }) - > NameCodes: ns2: ArrayOfNameCodes
                         LookupStateCounty(Parameters: ns2: StateCountyParameters, SearchType: ns2: StateCountyType,
                              _soapheaders = {
                                   request_header: ns0: Header
                              }) - > StateCounty: ns2: ArrayOfStateCounty
                         SaveQuery(QueryName: xsd: string, CriteriaXML: xsd: string, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Result: xsd: string
                         ValidateIds(Domain: xsd: string, DataType: xsd: string, Ids: ns1: ArrayOfId, _soapheaders = {
                              request_header: ns0: Header
                         }) - > Ids: ns1: ArrayOfId